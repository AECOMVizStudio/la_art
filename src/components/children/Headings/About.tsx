const About = () => {
  return (
    <section tabIndex={0} className="border-t border-gray-300 mb-8 p-8">
      ...
      <p className="font-medium pt-4">
        State Parks will gather public input and work with LA Aerial Rapid
        ...
        draft GPA proposal in 2025. Once State Parks determines the GPA meets
      ...
      <p className="font-medium pt-4">
        State Parks' GPA process will involve a public outreach effort to gather
        ...
        provide information and receive comment and input.
      </p>
    </section>
  );
};
