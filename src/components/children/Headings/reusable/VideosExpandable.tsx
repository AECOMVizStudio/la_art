    ...
    <div className="mb-4">
      ...
      <div>
        ...
        <div
          className={
            expanded
              ? 'grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 hover:pointer'
              : 'hidden'
          }
        >
          {props.map((video) => {
            return (
              <div
                key={video.vimeoCode}
                className="flex justify-start items-center sm:items-stretch p-1 mt-1 sm:p-2 border-2 hover:border-burnt-orange"
              >
