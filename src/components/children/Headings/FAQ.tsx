...
const faq = [
  ...
  },
  {
    ...
    answer:
      `The LA ART project is required to obtain a LASHP GPA. A GPA is subject to the review and approval of SPRC. SPRC approval of the LASHP GPA cannot occur prior to Metro's recertification of the LA ART Final EIR. Additional approvals may also be required from the City of Los Angeles and the California Department of Transportation (Caltrans) before the project is constructed`,
  },
  {
    question:
...
const FAQ = () => {
  return (
    <section tabIndex={0} className="border-t border-gray-300 mb-8 p-8">
      ...
      <h3 className="font-semibold pt-4">Updated July 22, 2025</h3>
      {faq.map((item, index) => (
        <div key={index}>
