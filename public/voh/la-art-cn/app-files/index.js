...
(function() {
  ...
  function CreateHeader(create){
    ...
    h1.innerHTML = "Welcome to the Hermosa Critical Minerals Environmental Impact Statement (EIS) Virtual Open House. Comments on the Draft EIS will be accepted from May 9 to June 23, 2025. Anonymous comments and comments submitted after the close of a designated comment period will not provide the commenter standing for administrative review." + "<br> </br>";
    var h2 = document.createElement('h2');
    h2.innerHTML = "Bienvenidos a la sesión abierta al público virtual del Informe de Impacto Ambiental (EIS, por sus siglas en ingles) de Minerales críticos de Hermosa. Los comentarios sobre el Borrador del EIS se aceptarán del 9 de mayo al 23 de junio de 2025. Los comentarios anónimos y los comentarios enviados después del cierre de un período de comentarios designado no le otorgarán al comentarista derecho a una revisión administrativa."
